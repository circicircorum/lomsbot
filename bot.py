...
class LOMS(discord.Client):
    ...
    async def process_command(self, message):
        ...
        if msg_tokens[0] == '!test':
            ...
            await message.channel.send('https://cdn.discordapp.com/attachments/658813940268269668/744914783660408904/image0-12.jpg')
        elif msg_tokens[0] == '!jail':
            await message.channel.send('https://cdn.discordapp.com/attachments/658813940268269668/744914783320539166/go_to_horny_jail_bonk.jpg')
